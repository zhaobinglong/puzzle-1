...
var Puzzle = /*#__PURE__*/function () {
  ...
  _createClass(Puzzle, [{
    ...
    value: function fit(clipart) {
      console.log('start fit', clipart); // 当前拼块索引
    ...
    value: function displayShell() {
      ...
      console.log(this.shellTimeline); // 创建一条时间轴
      ...
      return new Promise(function (resolve, reject) {
        console.log('new Promise', _this6.shellTimeline);

        _this6.stage.removeChild(_this6.fireworksContainer);

        resolve(); // this.shellTimeline.restart().call(e => {
